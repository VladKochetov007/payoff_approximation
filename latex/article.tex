...
\begin{enumerate}
    ...
    \end{equation}
    This formulation provides error weighting proportional to the target payout magnitude, 
    offering economic interpretation well-aligned with trading objectives. Furthermore, it 
    naturally enhances focus on regions with significant payout values, making it particularly 
