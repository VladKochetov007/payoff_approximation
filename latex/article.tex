...
Presented approach addresses these limitations by embracing the stochastic nature of markets
without imposing restrictive distributional assumptions. Instead of attempting to fit
market behavior into predetermined probability distributions as in \citep{Kuang2023}, 
this paper proposes a framework that can accommodate any empirically observed distribution. This 
distribution-free modeling approach acknowledges the complex, non-Gaussian nature of 
market price movements, which often exhibit fat tails and asymmetric behavior. It allows 
for direct incorporation of empirical distribution forecasts, enabling more accurate risk 
